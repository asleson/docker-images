# http4k/amazonlinux-liberica-nik-lambda-runtime

This image builds a runtime ZIP file containing a Java Liberica Native Image Kit (NIK) binary for Amazon Linux. It is designed to work with a ShadowJar containing an http4k AWS Lambda function.
Liberica NIK is built on top of GraalVM and is particularly useful for applications that make use of Java AWT classes.
...
http4k/amazonlinux-liberica-nik-lambda-runtime:latest <UBERJAR_PATH> <OUTPUT_ZIP_PATH?>
```
